...
<body>
    ...
    $result_in_progress = pg_query($db, "SELECT * FROM inc_idea WHERE author='" . $_SESSION['hash'] . "' and (status != 5 and status != 8)");


    $result_accepted = pg_query($db, "SELECT * FROM inc_idea WHERE author='" . $_SESSION['hash'] . "' and (status = 4 or status = 7)");
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-auto">
                ...
                <!-- <h5><?= $line_student['middle_name'] ?></h5>
                <h5><?= $line_student['last_name'] ?></h5> -->
                <!-- <div class="card" style="width: 18rem;">
                    <ul class="list-group list-group-flush">
                        <li class="list-group-item"><?= $line_student['first_name'] ?></li>
                        <li class="list-group-item"><?= $line_student['middle_name'] ?></li>
                        <li class="list-group-item"><?= $line_student['last_name'] ?></li>
                    </ul>
                </div> -->
            </div>
        </div>
        <div class="container mt-4">
            <form id="checkLog" action="DbShowReqScript.php" enctype="multipart/form-data" name="status" method="POST">
                <div class="row justify-content-center">
                    ...
                    <div class="col-12 col-sm-12 col-md-12 col-lg-auto col-xl-auto mb-sm-2 mb-md-2 mb-lg-0">
                        <button type="button" id="show_accept_ideas" value="show" style="margin-top: 15px;" href="?flag=3" class="btn btn-primary rounded-pill w-100" onclick="DBshowAcceptIdeas()">Принятые в обработке</button>
                        <input type="hidden" name="action" id="staus" value="and (status = 4 or status = 7)">
                    </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="container">
                                ...
                                <div class="col-auto">
                                        ...
                                        <p class="text-warning"> <?= $idea_status ?></p>
