...
if (!is_array($line)){
   $quary = "INSERT INTO inc_idea_vote VALUES(" . $_POST['postId'] . "," . $_SESSION['hash'] . "," . $_POST['dislikeBool'] . "," . $count[0] . ")";
    echo $quary;
    pg_query($db, (string) $quary);
}else{
   $quary = "UPDATE inc_idea_vote SET value = " . $_POST['dislikeBool'] . " WHERE idea_id = " . $_POST['postId'] . " and user_id =".$_SESSION['hash']. ";";
   echo $quary;
   pg_query($db, (string) $quary);
